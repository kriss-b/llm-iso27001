...
This is markdown, so contributing doesn't require being a developer — a policy fix, a control mapping, or a critical review is as valuable as a pull request.
...
All changes go through a pull request. Explain what changed and why; that's it.
