# Employee Security Awareness Training Procedure
...
| Phishing and Social Engineering | How to recognize and respond to phishing attacks. |
| Password Security | Best practices for creating and managing strong passwords. |
| Multi-Factor Authentication (MFA) | Importance of MFA and how to use it. |
| Safe Browsing and Email Practices | How to browse safely and handle emails securely. |
