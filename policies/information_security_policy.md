...
| **CISO**                    | Oversee ISMS implementation, compliance, and risk management.                    |
| **CTO**                     | Ensure security in system design, development, and operations.                    |
| **COO**                     | Manage supplier relationships and business continuity.                           |
| **Employees**               | Comply with policies, report incidents, and complete training.                    |
| **Third-Party Vendors**     | Comply with Company security requirements and contractual obligations.            |
