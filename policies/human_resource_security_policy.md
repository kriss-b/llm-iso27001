...
## 1. Purpose
This policy ensures the protection of information assets throughout the employee lifecycle in alignment with **ISO 27001:2022 (Controls A.6.1 – A.6.5)**, which cover screening, terms of employment, security training, disciplinary process, and responsibilities upon termination.

## 2. Scope
This policy applies to all employees, contractors, and third parties with access to the Company’s information systems or data.

## 3. Policy Statements
### 3.1 Pre-Employment
- Background checks shall be conducted for all new hires.
- Employment contracts shall include confidentiality and information security clauses.

### 3.2 During Employment
- Employees shall complete annual information security training.
- Access rights shall be reviewed quarterly and revoked when no longer needed.
- Employees shall report security incidents or vulnerabilities immediately.

### 3.3 Termination or Change of Employment
- Access rights shall be revoked on the last day of employment.
- Company assets (e.g., laptops, badges) shall be returned.
- Exit interviews shall include a review of confidentiality obligations.

### 3.4 Training and Awareness
- All employees and contractors shall complete information security awareness training upon onboarding and at least annually thereafter.
- Training covers key topics including data protection, acceptable use, phishing awareness, incident reporting, and password security.
- Role-specific training shall be provided where relevant — developers receive secure coding training, IT staff receive security operations training, and managers receive training on their security responsibilities.
...
|---------|------|-------|----------|---------|
| 1.0 | TBD | Chief People Officer (CPO) | ISMS Owner | Initial version |
